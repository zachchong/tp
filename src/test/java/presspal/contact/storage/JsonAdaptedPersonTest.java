...
public class JsonAdaptedPersonTest {
    ...
    private static final JsonAdaptedInterviewList VALID_INTERVIEW_LIST =
            new JsonAdaptedInterviewList(BENSON.getInterviews());
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ORGANISATION, VALID_ROLE, VALID_CATEGORIES, VALID_INTERVIEW_LIST);
    ...
    public void toModelType_invalidOrganisation_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        INVALID_ORGANISATION, VALID_ROLE, VALID_CATEGORIES, VALID_INTERVIEW_LIST);
    ...
    public void toModelType_invalidRole_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ORGANISATION, INVALID_ROLE, VALID_CATEGORIES, VALID_INTERVIEW_LIST);
    ...
    public void toModelType_invalidCategories_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ORGANISATION, VALID_ROLE, invalidCategories, VALID_INTERVIEW_LIST);
