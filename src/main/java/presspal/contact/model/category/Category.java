...
public class Category {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Categories names should be alphanumeric. It should not contain spaces and it should have at most 20 characters.";
