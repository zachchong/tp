...
Adds a person to the organisation book.
...
Shows a list of all persons in the organisation book.

Format: `list`

### Editing a person : `edit`

Edits an existing person in the organisation book.
...
Deletes the specified person from the organisation book.
...
Examples:
* `list` followed by `delete 2` deletes the 2nd person in the organisation book.
* `find Betsy` followed by `delete 1` deletes the 1st person in the results of the `find` command.

### Clearing all entries : `clear`

Clears all entries from the organisation book.
