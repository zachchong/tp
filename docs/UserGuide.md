...
| `o/`  | `ORGANISATION` | Company, school, outlet, etc.                     | Alphanumeric words with single spaces, 1–50 chars.<br/><br/>✅ **Valid:**<br/>- `o/NUS`<br/>- `o/Meta`<br/>- `o/New York Times` (single spaces)<br/><br/>❌ **Invalid:**<br/>- `o/ New York Times` (leading space)<br/>- `o/New  York Times` (double space)<br/>- `o/Ben & Jerry` (`&` not allowed)<br/>- `o/ACME-Asia` (hyphen not allowed)<br/>- `o/` (empty)                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `r/`  | `ROLE`         | Job title or position (e.g., Reporter, Lawyer).   | **Same rules as Organisation** (1–50 chars; alphanumeric words; **single spaces only**; no leading/trailing/multiple spaces; **no symbols/hyphens**).<br/><br/>✅ **Valid:** `r/Reporter`, `r/Data Analyst`<br/>❌ **Invalid:** `r/Sr. Reporter` (`.` not allowed), `r/Lead-Editor` (hyphen), `r/ Editor` (leading space)                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `e/`  | `EMAIL`        | Email address used for contacting the person.     | Format: `local-part@domain`.<br/>**Local-part:** letters/digits with `+ _ . -` **between** alphanumeric runs; **cannot start/end** with a special char.<br/>**Domain:** labels of letters/digits with optional **internal hyphens**; each label starts/ends alphanumeric; **final label ≥2 chars**; **no underscores** in domain.<br/><br/>✅ **Valid:**<br/>- `e/alice@example.com`<br/>- `e/a.b-c+d@sub.example.co`<br/>- `e/a_b@newsroom.io` (underscore allowed in local-part)<br/><br/>❌ **Invalid:**<br/>- `e/_alice@example.com` (local starts with `_`)<br/>- `e/alice-@example.com` (local ends with `-`)<br/>- `e/alice@exa_mple.com` (underscore in domain)<br/>- `e/alice@example.c` (final label 1 char)<br/>- `e/alice@-example.com` (domain label starts with `-`) |
| `p/`  | `PHONE`        | Phone number (no formatting required).            | **Digits only**, minimum **3** digits.<br/><br/>✅ **Valid:** `p/123`, `p/98765432`<br/>❌ **Invalid:** `p/12` (too short), `p/+651234567` (`+` not allowed), `p/123-4567` (hyphen), `p/(123)` (symbols), `p/12 34` (space)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `c/`  | `CATEGORY`     | Tag for grouping (e.g., `emergency`, `election`). | **Alphanumeric only**, **no spaces**, **≤ 20 chars**.<br/><br/>✅ **Valid:** `c/emergency`, `c/singapore2025`<br/>❌ **Invalid:** `c/urgent-news` (hyphen), `c/urgent news` (space), `c/veryveryverylongcategory` (21+ chars), `c/` (empty)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
